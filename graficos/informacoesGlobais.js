...
const porcentagemConectada = ((pessoasConectadas / pessoasNoMundo) * 100).toFixed(2);
    ...
    paragrafo.innerHTML = `<p class="graficos-container__texto">
                Cerca de 38% das mais de <span>${pessoasNoMundo}</span> de pessoas do mundo estão no
          mercado de trabalho, ou seja, aproximadamente 3 bilhões de
          trabalhadores. Do total de trabalhadores, ⅔ deles (67%) precisam de
          ...
          trabalho, de forma a não precisar de deslocamento. Entre os que
            precisam de transporte, o tempo necessário para isso é de cerca de  <span>${Math.round((dados.tempo_medio - horas) * 60)}</span>
